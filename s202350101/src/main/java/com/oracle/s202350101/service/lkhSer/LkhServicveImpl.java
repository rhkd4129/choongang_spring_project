...
public class LkhServicveImpl implements LkhService {
	...
	//#####################################################################################################
	//############   작업보드  화면에 밑에 프로젝트 단계별로 보여주는 것과 진행중인 작업 보여주는 것 data 처리     #######
	//#####################################################################################################
	@Override
	...
	//#######################################################################
	//############  	하나의 메서드에서 여러개의 dao 메서드 수행 트랜잭션처리  ##########
	//#######################################################################
	...
	//#######################################################################
	//############  	하나의 메서드에서 여러개의 dao 메서드 수행 트랜잭션 처리  ##########
	//#######################################################################
		...
		try {
			...
			if (attachDeleteList != null && !attachDeleteList.isEmpty()) {
				for(String no :attachDeleteList)	{
					...
					// dao의 이름은 delete지만 실제로는 파일 경로아 이름을 셀렉트해온 후 최종적으로 삭제하는 것
					/**************************************************************************/
	...
	//#####################################################################################################
	//############      휴지통 관련 기능들  작업삭제 ,휴지통 목록, 휴지통 개수, 영구삭제, 복구하기     #################
	//#####################################################################################################
	@Override
