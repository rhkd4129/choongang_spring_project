...
<div class="container-fluid">
	<div class="row">
		...
		<main id="center" class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
			...
			<form action="free_update2" method="post">
				...
				<colgroup>
					...
					<tr> <th>본문</th> <td> <textarea  cols="50"  rows="10"   name="doc_body" class="form-control">${content.doc_body}</textarea> </td> </tr>
					<tr> <th>첨부파일명</th> <td><input  id="file"  type="file" name="file" class="form-control form-control-sm"></td> </tr>
				</table>
			</form>
