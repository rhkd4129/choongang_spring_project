...
// 두 날짜 사이의 차이 계산
                    const timeDiff = projectEndDate - projectStartDate;
// 밀리초(ms)를 일(day)로 변환
                    const totalDays = Math.floor(timeDiff / (1000 * 60 * 60 * 24));
// 시작 날짜와 현재 날짜 사이의 차이 계산
                    const timeDiffFromStart = currentDate - projectStartDate;
// 밀리초(ms)를 일(day)로 변환
                    const daysPassed = Math.floor(timeDiffFromStart / (1000 * 60 * 60 * 24));

                    console.log("프로젝트 시작일: " + projectStartDate);
                    console.log("프로젝트 종료일: " + projectEndDate);
                    console.log("프로젝트 기간: " + totalDays + "일");
                    console.log("시작일로부터 오늘까지 경과한 일 수: " + daysPassed + "일");
