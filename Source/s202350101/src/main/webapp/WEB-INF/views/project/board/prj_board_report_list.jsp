										...
										<tr>
											<td>
												<select class="form-select" name="search" style="font-size:0.8rem">
													...
													<option value="s_user_name">본문</option>
												</select>
											</td>
					...
					<nav aria-label="Page navigation example">
					  <ul class="pagination justify-content-center">
						...
						<c:if test="${page.startPage > page.pageBlock}">
						   	<li class="page-item disabled"><a class="page-link" href="prj_board_report_list?currentPage=${page.startPage-page.pageBlock}" tabindex="-1" aria-disabled="true">Previous</a></li>
						</c:if>
					    <c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
							...
							<a class="page-link" href="prj_board_report_list?currentPage=${i}">${i}</a></li>
						</c:forEach>						
					    <c:if test="${page.endPage > page.totalPage}">
					    	<li class="page-item"><a class="page-link" href="prj_board_report_list?currentPage=${page.startPage+page.pageBlock}">Next</a></li>
					    </c:if>
