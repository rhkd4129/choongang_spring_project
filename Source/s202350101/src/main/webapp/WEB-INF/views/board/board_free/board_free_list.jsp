	...
	<div class="row">
		...
		<main id="center" class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
			...
			<div class="container-fluid">
				...
				<!-- 전체 리스트 -->
				<h6 class="mt-2 pt-2" style="text-align:right">총 건수 : ${freeTotal} </h6>
				<table class="table">
			 		<colgroup>
						<col width="5%"></col><col width="10%"></col><col width="37%"></col><col width="12%"></col>
						<col width="10%"></col><col width="12%"></col><col width="7%"></col><col width="7%"></col>
				...
				<nav aria-label="Page navigation example">
				  <ul class="pagination justify-content-center">
					...
					<c:if test="${page.startPage > page.pageBlock }">
						<li class="page-item"><a class="page-link" href="board_free?currentPage=${page.startPage - page.pageBlock }" tabindex="-1" aria-disabled="true">이전</a></li>
					</c:if>
					...
					<c:forEach var="i" begin="${page.startPage }" end="${page.endPage }">
						...
						<a class="page-link" href="board_free?currentPage=${i}">${i}</a></li>
					</c:forEach>
					
					<c:if test="${page.endPage < page.totalPage }">
						<li class="page-item"><a class="page-link" href="board_free?currentPage=${page.startPage + page.pageBlock }')">다음</a></li>
					</c:if>
				  </ul>
				</nav>
			</div>
