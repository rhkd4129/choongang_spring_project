...
<div class="container-fluid">
	<div class="row">
		...
		<main id="center" class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
			...
			<form action="qna_update2" method="post">
				...
				<table border="1">
					...
					<tr> <th>질문 제목</th> <td> <textarea  cols="50"  rows="1"    name="subject">${content.subject}</textarea> </td> </tr>
					<tr> <th>질문 내용</th> <td> <textarea  cols="50"  rows="10"   name="doc_body">${content.doc_body}</textarea> </td> </tr>
