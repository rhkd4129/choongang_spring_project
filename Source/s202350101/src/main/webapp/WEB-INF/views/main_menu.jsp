      ...
      <li class="mb-1">
        ...
        <div class="collapse show" id="project-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1">
            ...
            <li><a href="javascript:gotoCheckProjectID('prj_home','${userInfo.project_id}')" class="link-body-emphasis d-inline-flex text-decoration-none rounded"><svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"></use></svg>프로젝트 Home</a></li>
