...
<div class="container-fluid">
	<div class="form-mypage" style="width:800px">
		<form class="needs-validation" novalidate="">
			...
			<div class="col-12">
				<img class="uploadFile" style="size: width: 250px; height: 250px;" alt="UpLoad File" src="${pageContext.request.contextPath}/${userInfoDTO.attach_path }/${userInfoDTO.attach_name}"><br>
				<input type="file" class="form-control" name="file1" id="file1">
			</div>
			...
			<div class="col-12">
				...
				<span><input type="button" class="btn btn-danger btn-lg" value="ID" style="z-index:-1"></span>
			...
			<div class="col-12">
				<label for="user_gender" class="form-label" style="margin-right:30px">성별</label>
			...
			<div class="col-12">
				...
				<div class="input-group has-validation">
					...
					<span><button type="button" class="btn btn-primary btn-lg" onclick="return send_save_mail()">수정</button></span>
				</div>
				<div id="mail_number" name="mail_number" style="display: none">
				    <input type="text" name="number" id="number" placeholder="인증번호 입력">
				    <button class="confirmBtn" name="confirmBtn" id="confirmBtn" onclick="return confirm_authNumber()">확인</button>
				    <small class="invalid-feedback" style="color: red"><div class="time"></div></small>
		    		<small class="invalid-feedback" style="color: red"><div id="msg2"></div></small>
		    		<small class="invalid-feedback" style="color: red"><form:errors path="user_email"/></small>
		    		<input type="hidden" id="Confirm" value="">
		    	</div>
			</div>
